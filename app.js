...
function showError(msg) {
    ...
    if (!box) {
        ...
        box.style.cssText = 'position:fixed;top:0;left:0;right:0;z-index:99999;background:#b91c1c;color:#fff;padding:14px;font-family:monospace;font-size:12px;direction:ltr;text-align:left;white-space:pre-wrap;max-height:40vh;overflow:auto;';
...
class QuizUI {
    ...
    bindEvents() {
        ...
        if (!this.startBtn) { showError('startBtn غير موجود بالصفحة!'); return; }

        if (!this.nextBtn) { showError('nextBtn غير موجود بالصفحة!'); return; }

        if (!this.startQuizFormBtn) { showError('startQuizFormBtn غير موجود بالصفحة!'); return; }
        ...
        if (this.submitChoiceBtn) {
            ...
            this.submitChoiceBtn.addEventListener('click', () => {
                ...
                if (phone.length < 10) { this.showToast('يرجى إدخال رقم هاتف صحيح', true); return; }

                if (branch.length < 2) { this.showToast('يرجى إدخال الفرع الأكاديمي', true); return; }
                ...
                fetch('https://docs.google.com/forms/d/e/1FAIpQLSczXBeKu-d9DOt1E7Y6NDgv74G24TlH_0shVgFQEiUH3ePgNg/formResponse', {
        ...
        if (this.startQuizFormBtn) {
            ...
            this.startQuizFormBtn.addEventListener('click', () => {
                ...
                if (name.length < 3) { this.showToast('يرجى إدخال الاسم الكامل', true); return; }

                if (phone.length < 10) { this.showToast('يرجى إدخال رقم موبايل صحيح', true); return; }

                if (!age || Number(age) < 10 || Number(age) > 100) { this.showToast('يرجى إدخال عمر صحيح', true); return; }

                if (!unionChoice) { this.showToast('يرجى اختيار نعم أو لا', true); return; }
                ...
                if (academicBranch) teamPayload.append('entry.234839250', academicBranch);



                fetch('https://docs.google.com/forms/d/e/1FAIpQLSdNUYMpALSi4m2sdl99a1IiTPPerAvXGutEcJNnaWrAsYWHKw/formResponse', {
                ...
                }).catch(e => console.error('Team Form error:', e));
                ...
                if (academicBranch) myPayload.append('entry.887557934', academicBranch);



                fetch('https://docs.google.com/forms/d/e/1FAIpQLSf3VwYRzvAdiG-ImH9ldW16-qvEc5wa_yl3bDzt1ZDyHLLZmA/formResponse', {
                ...
                }).catch(e => console.error('My Form error:', e));
        ...
        this.skipBtn.addEventListener('click', () => {
            ...
            if (this.engine.skip()) {
                ...
                this.showToast("يمكنك تخطي سؤالين فقط.", true);
